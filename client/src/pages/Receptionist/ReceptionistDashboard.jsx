    ...
    const panelNames = [
        {
            ...
            css: `flex gap-3 items-center transition-all duration-200 ${currentPanel === 'home' || currentPanel === 're' ? "text-black font-semibold" : "text-gray-400 hover:text-black"
                }`,
            func: 'home'
        },
        {
            ...
            css: `flex gap-3 items-center transition-all duration-200 ${currentPanel === 'loan' ? "text-black font-semibold" : "text-gray-400 hover:text-black"
                }`,
            func: 'loan'
        },
        {
            ...
            css: `flex gap-3 items-center transition-all duration-200 ${currentPanel === 'view' ? "text-black font-semibold" : "text-gray-400 hover:text-black"
                }`,
            func: 'view'
        },
        {
        ...
        },
        {
            ...
            css: `flex gap-3 items-center transition-all duration-200 ${currentPanel === 'monthlyExp' ? "text-black font-semibold" : "text-gray-400 hover:text-black"
                }`,
            func: 'monthlyExp'
        },
        {
            ...
            css: `flex gap-3 items-center transition-all duration-200 ${currentPanel === 'monthlyPetty' ? "text-black font-semibold" : "text-gray-400 hover:text-black"
                }`,
            func: 'monthlyPetty'
        },
        {
        ...
        },
        {
            ...
            css: `flex gap-3 items-center text-gray-400 hover:text-black transition-all duration-200`,
            func: 'logout'
        }
    ];
    ...
    return (
        <>
            ...
            <div className='bg-gray-100 w-full text-black flex gap-8 h-fit md:min-h-dvh p-8'>
                {/* Sidebar */}
                <div className='bg-white md:w-[25%] p-8 rounded-2xl shadow-xl hidden md:flex md:flex-col gap-6'>
