...
const About = () => {
    ...
    return (
        <div className='bg-white text-black flex flex-col gap-10 py-15'>
            <div className='flex flex-col items-center gap-4 font-extralight'>
                ...
                <div className='flex flex-col items-center text-3xl md:text-8xl gap-4'>
                    <div>N K R S</div>
                    <div className='tracking-[2rem] font-medium'>Lanka Capital</div>
                    <div className='text-5xl'>PVT. LTD.</div>
                </div>
                <span>We support your business journey with trusted financing. Together, we build stronger businesses.</span>
            </div>

            <div className='grid grid-cols-3 self-center gap-20'>
                {aboutDet.map((detail, index) => {
                    return (
                        <div
                            key={index}
                            className={`rounded-xl w-[20rem] flex flex-col 
                                        ${index % 3 === 1 ? "mt-15 scale-[1.1]" : "scale-[0.9]"}
                                        `}
                        >
