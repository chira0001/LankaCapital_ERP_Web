...
const ReceptionistDashboard = () => {
    ...
    const panelNames = [
        ...
        },
        {
            ...
            css: `flex gap-3 items-center ${panel === 'view' ? "text-black" : "text-gray-400"}`,
            func: 'view'
        },
        {
            name: "Settings",
            ...
            css: `flex gap-3 items-center ${panel === 'settings' ? "text-red-700" : "text-red-300"}`,
            func: 'settings'
        }
    ];
        ...
        <>
            ...
            <div className='bg-gray-100 text-black flex gap-8 h-fit md:min-h-dvh p-8'>
                ...
                <div className='bg-white w-full md:w-5/6 p-4 md:p-8 rounded-2xl shadow-xl'>
                    ...
                    {panel === 'view' && <div>
                        <h1 className='mb-8'>View Customer</h1>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            <div className='flex flex-col'>
                                <span>Business Name</span>
                                <input type="text" className='border border-gray-400 rounded-lg px-3 py-1.5 w-full pr-10' />
