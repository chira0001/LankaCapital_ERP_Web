                                        ...
                                        {currentPayments.map((value, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-3 py-3 sm:px-6 sm:py-4">
                                                    <span className={`inline-flex rounded-full bg-amber-50 px-2 py-1 text-xs font-semibold text-amber-700 sm:px-3 ${styleArrearsAmount((value.paidAmount || 0) - (selectedLoan?.installmentValue || 0))}`}>
                                                        {formatLKR(
                                                            (value.paidAmount || 0) -
