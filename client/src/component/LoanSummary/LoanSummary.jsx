        ...
        <div className="min-h-screen w-full p-3">
            ...
            <div className="mx-auto max-w-[1600px]">
                ...
                <section className="hidden md:block overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                    {/* ... original table code for desktop ... */}
                        ...
                        <div className="flex flex-col gap-2 border-t border-gray-200 bg-gray-50 px-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-5 sm:py-4">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-medium text-gray-700 transition hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40 sm:px-4 sm:text-sm"
                                >
                                    Previous
                                </button>
                ...
                <section className="md:hidden space-y-3">
                            ...
                            <div className="flex items-start justify-between gap-3">
                                <div className="min-w-0">
                                    ...
                                    <p className="mt-1 text-xs text-gray-600">
                                        {app.customer?.name || "—"}
                                        {app.customer?.nic && (
                                            <span className="text-gray-400"> · {app.customer.nic}</span>
                                        )}
                                    </p>
                                </div>
                                <span
                    ...
                    {/* Mobile pagination (same as desktop but simplified) */}
                    {totalMainPages > 1 && (
                                    ...
                                    {currentPayments.map((value, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-xs text-gray-500">
                                                {value.paidAt && (
                                                    <span>
                                                        {new Date(value.paidAt).toLocaleDateString("en-LK", {
                                                            day: "numeric",
                                                            month: "short",
                                                            year: "numeric",
                                                        })}{" "}
                                                        ·{" "}
                                                        {new Date(value.paidAt).toLocaleTimeString("en-LK", {
                                                            hour: "2-digit",
                                                            minute: "2-digit",
                                                            hour12: true,
                                                        })}
